...
public:
    ...
    ErrorCode twist(int time = 500, int offset_time = 500);
    static const int nb_twisting_sequence = 10;
    float twisting_sequence[nb_walking_sequence][LEG_NB][3] = {
        {{ANG_T_FL, X_PT_FL, Y_TOUCHING},
         {ANG_T_FR, X_PT_FR, Y_TOUCHING},
         {ANG_T_RL, X_PT_RL, Y_TOUCHING},
         {ANG_T_RR, X_PT_RR, Y_TOUCHING}},

        {{ANG_T_FL, X_PT_FL, Y_TOUCHING},
         {ANG_T_FR, X_PT_FR, Y_NOT_TOUCHING},
         {ANG_T_RL, X_PT_RL, Y_TOUCHING},
         {ANG_T_RR, X_PT_RR, Y_TOUCHING}},
        ...
        //  {ANG_1, X_1, Y_TOUCHING},
        //  {ANG_2, X_2, Y_TOUCHING}},
        // {{ANG_T_RL, X_NT_FL, Y_TOUCHING},
        //  {ANG_T_RR, X_NT_FR, Y_TOUCHING},
        //  {ANG_T_FL, X_NT_RL, Y_TOUCHING},
        //  {ANG_T_FR, X_NT_RR, Y_TOUCHING}},
        {{ANG_1, X_1, Y_TOUCHING},
         {ANG_2, X_2, Y_TOUCHING},
         {ANG_1, X_1, Y_TOUCHING},
         {ANG_2, X_2, Y_TOUCHING}},
